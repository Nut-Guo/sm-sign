...
public class InAppBillingService extends Service {
    private final IInAppBillingService.Stub mInAppBillingService = new IInAppBillingService.Stub() {
        ...
        public Bundle getBuyIntentToReplaceSkus(int apiVersion, String packageName, List<String> list, String newSku, String type, String developerPayload) throws RemoteException {
